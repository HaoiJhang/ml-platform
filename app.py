...
HERO_IMAGE_PATH = PROJECT_ROOT / "data" / "hero.jpg"
...
def _configure_llm_settings(settings: Settings) -> Settings:
    ...
    _section_caption(
        ...
        "Set OPENAI_API_KEY environment variable (or Streamlit Secrets on Cloud) to avoid re-entering."
    )
    ...
    with config_cols[2]:
        model = st.text_input("Model", key="_llm_model", placeholder="default")
